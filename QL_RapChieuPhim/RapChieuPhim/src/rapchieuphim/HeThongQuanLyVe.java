 ...
 * @author NGUYENLEHAI
 */
public class HeThongQuanLyVe extends javax.swing.JFrame {

    /**
     * Creates new form HeThongQuanLyVe
     */
    public HeThongQuanLyVe() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Hệ Thống Quản Lý Chức Năng Bán Vé");
        ...
        jLabel3.setText("Ngày Bán Vé");

        jLabel4.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel4.setText("Mã Xuất Chiếu");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HeThongQuanLyVe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HeThongQuanLyVe().setVisible(true);
            }
        });
    }
